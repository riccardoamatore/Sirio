...
import {
  ...
  getGovernorContract,
  getMdexMasterchefContracts,
  getSirioDiversifierContract,
  getSirioMasterchefContract,
  getSirioWrapperContract
...
export const useMdexMasterchef = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getMdexMasterchefContracts(library.getSigner()), [library])
}

export const useSirioMasterchef = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getSirioMasterchefContract(library.getSigner()), [library])
}

export const useSirioDiversifier = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getSirioDiversifierContract(library.getSigner()), [library])
}

export const useGovernor = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getGovernorContract(library.getSigner()), [library])
}
...
export const useSirioWrapper = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getSirioWrapperContract(library.getSigner()), [library])
}
